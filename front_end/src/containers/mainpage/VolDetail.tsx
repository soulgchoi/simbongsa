...
class VolDetail extends React.Component<IProps, {}> {
  ...
  render() {
    ...
    return (
      <div className="">
        <h3 className="">{selectedVolunteer.v_title}</h3>
        <table className="">
          <tbody>
            <tr>
              <td>봉사기간</td>
              <td>
                {selectedVolunteer.v_pBgnD.replace(/-/g, ".")} ~{" "}
                {selectedVolunteer.v_pEndD.replace(/-/g, ".")}
              </td>
            </tr>
            <tr>
              <td>봉사시간</td>
              <td>
                {selectedVolunteer.v_bgnTm.slice(0, 5)} ~{" "}
                {selectedVolunteer.v_endTm.slice(0, 5)}
              </td>
            </tr>
            <tr>
              <td>모집기간</td>
              <td>
                {selectedVolunteer.v_mBgnD.replace(/-/g, ".")} ~{" "}
                {selectedVolunteer.v_mEndD.replace(/-/g, ".")}
              </td>
            </tr>
            <tr>
              <td>모집인원</td>
            ...
            <tr>
              <td>봉사자유형</td>
              <td>
                {selectedVolunteer.v_adult === "Y" ? "성인" : null}{" "}
                {selectedVolunteer.v_young === "Y" ? "청소년" : null}
              </td>
            </tr>
            <tr>
              <td>모집기관</td>
