...
public class CallRestWS_detail {
	public String restClient(String i) throws Exception{ //일단 퍼블릭으로 바꿔봄
		...
		*/
		String addr = "http://openapi.1365.go.kr/openapi/service/rest/VolunteerPartcptnService/getVltrPartcptnItem"+"?ServiceKey=";
		...
		//parameter setting
		parameter = parameter + "&" + "progrmRegistNo=" + i; //
